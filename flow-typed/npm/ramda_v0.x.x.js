...
declare module ramda {
  ...
  */
  ...
  declare function chain<T, V: Monad<T> | Array<T>>(fn: (a: T) => V, x: V): V
  ...
  declare function sortWith(any): any
  declare function descend(any): any
  declare function reduceWhile(any): any
